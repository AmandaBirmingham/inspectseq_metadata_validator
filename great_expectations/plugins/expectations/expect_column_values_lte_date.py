...
class ColumnValuesLteDate(ColumnMapMetricProvider):
    condition_metric_name = "column_values.date_lte"
    ...
    def _pandas(
        ...
        **kwargs
        ...
        # def map_func(str_date):
        #     return datetime.strptime(max_value, "%Y-%m-%d %H:%M:%S.%f %z")

        #compare_date = parse(max_value)
        try:
            compare_date = datetime.strptime(max_value, "%Y-%m-%d %H:%M:%S")
        except ValueError as ex:
            compare_date = datetime.fromisoformat(max_value)
...
class ExpectColumnValuesLteDate(ColumnMapExpectation):
    """Expect values in this column to be timezone-aware dates less than or equal to an input date."""
    ...
    examples = [
        {
            "data": {
                "dates_after_jan_2019": ["2021-01-14 14:07:46.878991+00:00",
                                          "2019-12-22 00:00:00+00:00"],
                "dates_before_jan_2019": ["2018-01-14 14:07:46.878991+00:00",
            ...
            "tests": [
                {
                    ...
                    "in": {"column": "dates_before_jan_2019",
                           "max_value": "2019-01-01 00:00:00"
                           },
                           "out": {
                        "success": True,
                    },
                },
                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "dates_after_jan_2019",
                           "max_value": "2019-01-01 00:00:00"
                           },
                    "out": {
                        "success": False,
    ...
    map_metric = "column_values.date_lte"
    ...
    success_keys = ("mostly", "max_value", "dates_have_tz")
    ...
    def _prescriptive_renderer(
        ...
        template_str = "must be less than or equal to input date"
...
if __name__ == "__main__":
    ExpectColumnValuesLteDate().print_diagnostic_checklist()

# Note to users: code below this line is only for integration testing -- ignore!

# diagnostics = ExpectColumnValuesLteDate().run_diagnostics()
#
